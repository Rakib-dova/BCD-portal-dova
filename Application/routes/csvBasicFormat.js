...
const cbGetCsvBasicFormat = async (req, res, next) => {
  ...
  console.log('cbGetCsvBasicFormat14')
  if (req.session.formData) {
    console.log('cbGetCsvBasicFormat14-1')

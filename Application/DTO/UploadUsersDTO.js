...
const userRole = {
  1: 'a6a3edcd-00d9-427c-bf03-4ef0112ba16d', // テナント管理者(Company admin)
  ...
  2: 'fe888fbb-172f-467c-b9ad-efe0720fecf9', // 経理部門担当者(Accounts payable)
  ...
  3: '4fc13d38-6a97-4b48-a2f2-f16733a5a8ea', // 経理部門文書担当者(Accounts payable documents handler)

...
const factory = (contract, bulkInsertUserDataList) => {
  ...
  const userTemplate = {
    Id: null,
    CompanyAccountId: contract.contractId,
    Username: '',
    FirstName: '',
    LastName: '',
    Language: 'ja',
...
const userRole = {
  ...
  '04': 'fe888fbb-172f-467c-b9ad-efe0720fecf9', // 経理部門担当者(Accounts payable)
  '05': '05479e46-91b0-4aa1-8d87-8281430b1030', // 購買要求者(Requester)
  '06': 'f42a3d94-4e8e-4b2d-8acf-9cae58d23d9b', // サプライヤーオンボーダー
  '07': '7a92b67a-5f50-45ea-9757-4c370f9bf937', // サプライヤーバリデーター
  '08': '8370ee3e-5f31-47bf-a139-d4218fb7689f', // 読み取り専用(Read-only)
  '09': 'e9eb8dde-9477-4076-aef6-7ce6577b6edb', // 文書管理付き読み取り専用(Read-only plus documents)
  10: '37a511e3-7269-4dd7-b80e-013f543589b7', // トーク付き読み取り専用(Read-only plus conversations)
  11: 'ad298300-ea11-11e4-b571-0800200c9a66', // 制限されたアクセス
  12: '509ac71b-66af-4799-b8eb-741c79d9635f', // タスク管理者(Queue Manager)
  13: '260cbffb-d59e-47bd-81ea-ae7bba81448d', // タスクリゾルバー
  14: '4fc13d38-6a97-4b48-a2f2-f16733a5a8ea', // 経理部門文書担当者(Accounts payable documents handler)
  15: '7915f40a-7564-4c20-b97a-01e277d03039', // 見積書の閲覧専用(Quote documents view-only access)

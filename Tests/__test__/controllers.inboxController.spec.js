...
describe('inboxControllerのテスト', () => {
  ...
  describe('getWorkflow', () => {
    ...
    test('正常:自分が依頼した場合', async () => {
      ...
      expect(result[0]).toHaveProperty('workflowStatus', '承認依頼中')
      ...
      expect(result[1]).toHaveProperty('workflowStatus', '承認依頼中')
      ...
      expect(result[2]).toHaveProperty('workflowStatus', '承認依頼中')
      ...
      expect(result[3]).toHaveProperty('workflowStatus', '承認依頼中')

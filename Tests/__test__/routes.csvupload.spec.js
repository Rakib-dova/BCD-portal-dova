...
describe('csvuploadのテスト', () => {
  ...
  const uploadFormatDetailResult = [
    ...
    },
    {
      uploadFormatId: uploadFormatId,
      serialNumber: '4',
      uploadFormatItemName: '取引先メールアドレス',

...
describe('pdfInvoiceのテスト', () => {
  ...
  describe('コールバック:pdfInvoiceEdit', () => {
    ...
    test('正常: 印影なし、ロゴなし、項目割引ありx2、全体割引ありx2', async () => {
      ...
      expect(response.render).toHaveBeenCalledWith('pdfInvoice', exprectedEditData.noSealImpNoLogoHasInvDisx2HasLineDisx2)
    })
  ...
  describe('コールバック:pdfInvoiceShow', () => {
    ...
    test('正常: 印影あり、ロゴあり、項目割引あり', async () => {
      ...
      expect(response.render).toHaveBeenCalledWith('pdfInvoice', exprectedShowData.hasSealImpHasLogoHasLineDis)
    })
    test('正常: 印影あり、ロゴなし、項目割引ありx3', async () => {
      request.params.invoiceId = 'dummyId'
      accessTradeshift.mockReturnValue(accountInfoTestData.noLogo) // ユーザ情報正常取得を想定する
      ...
      expect(response.render).toHaveBeenCalledWith('pdfInvoice', exprectedShowData.hasSealImpNoLogoHasLineDisx3)
    })
    test('正常: 印影なし、ロゴあり、全体割引あり', async () => {
      request.params.invoiceId = 'dummyId'
      accessTradeshift.mockReturnValue(accountInfoTestData.hasLogo) // ユーザ情報正常取得を想定する
      ...
      expect(response.render).toHaveBeenCalledWith('pdfInvoice', exprectedShowData.noSealImpHasLogoHasInvDis)
    })
    test('正常: 印影あり、ロゴあり、全体割引ありx3', async () => {
      request.params.invoiceId = 'dummyId'
      accessTradeshift.mockReturnValue(accountInfoTestData.hasLogo) // ユーザ情報正常取得を想定する
      ...
      expect(response.render).toHaveBeenCalledWith('pdfInvoice', exprectedShowData.hasSealImpHasLogoHasInvDisx3)
    })
    test('正常: 印影なし、ロゴあり、項目割引あり、全体割引あり', async () => {
      request.params.invoiceId = 'dummyId'
      accessTradeshift.mockReturnValue(accountInfoTestData.hasLogo) // ユーザ情報正常取得を想定する
      ...
      expect(response.render).toHaveBeenCalledWith('pdfInvoice', exprectedShowData.noSealImpHasLogoHasInvDisHasLineDis)
    })
    test('正常: 印影なし、ロゴなし、項目割引ありx2、全体割引ありx2', async () => {
      request.params.invoiceId = 'dummyId'
      accessTradeshift.mockReturnValue(accountInfoTestData.noLogo) // ユーザ情報正常取得を想定する
      ...
      expect(response.render).toHaveBeenCalledWith('pdfInvoice', exprectedShowData.noSealImpNoLogoHasInvDisx2HasLineDisx2)
    })
    test('準正常: 請求書IDなしの不正リクエスト', async () => {
      request.params.invoiceId = undefined

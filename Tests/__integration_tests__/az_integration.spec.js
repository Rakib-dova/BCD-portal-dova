...
describe('ルーティングのインテグレーションテスト', () => {
  ...
  describe('DBにアカウント管理者・一般ユーザ共に登録済/アカウント管理者としてリクエスト', () => {
    ...
    //     { contractStatus: '11' },
    //     { where: { tenantId: '221559d0-53aa-44a2-ab29-0c4a6cb02bde' } }
    //   )
    //   const res = await request(app)
    //     .get('/change')
    //     .set('Cookie', acCookies[0].name + '=' + acCookies[0].value)
    ...
    //   await db.Contract.destroy({ where: { tenantId: '221559d0-53aa-44a2-ab29-0c4a6cb02bde' } })
    //   await db.Order.destroy({ where: { tenantId: '221559d0-53aa-44a2-ab29-0c4a6cb02bde' } })
    // })
  })
  ...
  describe('DBにアカウント管理者・一般ユーザ共に登録済/一般ユーザとしてリクエスト', () => {
    ...
    //     orderType: '10',
    //     orderData:
    //       ' {"contractBasicInfo":{"sysManageId":"221559d0-53aa-44a2-ab29-0c4a6cb02bde","orderId":"","orderType":"010","contractChangeName":"","contractChangeAddress":"","contractChangeContact":"","appDate":"","OpeningDate":"","contractNumber":"","salesChannelCode":""},"contractAccountInfo":{"contractAccountId":"","customerType":"","commonCustomerId":""},"contractList":[{"contractType":""}],"prdtList":[{"prdtCode":"BF1021000000100","appType":"010"}]}'
    //   })
    // })
    ...
    //   // 契約ステータス変更(利用登録済み)
    //   await db.Contract.update(
    //     { contractStatus: '99', deleteFlag: 'true' },
    //     { where: { tenantId: '221559d0-53aa-44a2-ab29-0c4a6cb02bde' } }
    //   )
    //   const res = await request(app)
    //     .get('/change')

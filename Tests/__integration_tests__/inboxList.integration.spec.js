...
describe('受領した請求書一覧のインテグレーションテスト', () => {
  ...
  describe('1.契約ステータス：未登録', () => {
    // 利用登録をしていないため、受領した請求書一覧ページ利用できない
  ...
  describe('3.契約ステータス：登録申込', () => {
    // テナントステータスが「新規申込」、受領した請求書一覧ページ利用可能
  ...
  describe('4.契約ステータス：登録受付', () => {
    // テナントステータスが「新規受付」、受領した請求書一覧ページ利用可能
  ...
  describe('5.契約ステータス：契約中', () => {
    // テナントステータスが「契約中」、受領した請求書一覧ページ利用可能
  ...
  describe('6.契約ステータス：変更申込', () => {
    // テナントステータスが「変更申込」、受領した請求書一覧ページ利用可能
  ...
  describe('7.契約ステータス：変更受付', () => {
    // テナントステータスが「変更受付」、受領した請求書一覧ページ利用可能
  ...
  describe('8.契約ステータス：解約申込', () => {
    // テナントステータスが「解約申込」、受領した請求書一覧ページ利用不可
  ...
  describe('9.契約ステータス：解約受付', () => {
    // テナントステータスが「解約受付」、受領した請求書一覧ページ利用不可
  ...
  describe('10.契約ステータス：解約', () => {
    // テナントステータスが「解約」、受領した請求書一覧ページ利用不可
